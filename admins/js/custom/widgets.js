...
var KTWidgets = function () {
    ...
    var initMixedWidget4 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var color = element.getAttribute('data-kt-chart-color');
            var datareview = element.getAttribute('data-kt-value');           
            var baseColor = KTUtil.getCssVariableValue('--bs-' + color);
            var lightColor = KTUtil.getCssVariableValue('--bs-light-' + color );
    ...
    var initMixedWidget15 = function() {
        var charts = document.querySelectorAll('.mixed-widget-15-chart');
    ...
    var initMixedWidget10 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            datamonths = element.getAttribute("data-kt-months");
            datamonths = datamonths.split(', ');
            datasales = element.getAttribute("data-kt-sales");
            datasales = datasales.split(', ');
            datarevenue = element.getAttribute("data-kt-revenue");
            datarevenue = datarevenue.split(', ');
            height = parseInt(KTUtil.css(element, 'height'));
    ...
    var initMixedWidget11 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            datamonths = element.getAttribute("data-kt-months");
            datamonths = datamonths.split(', ');
            datacustomers = element.getAttribute("data-kt-customers");
            datacustomers = datacustomers.split(', ');
            datatransactions = element.getAttribute("data-kt-transactions");
            datatransactions = datatransactions.split(', ');
            height = parseInt(KTUtil.css(element, 'height'));
            baseColor = KTUtil.getCssVariableValue('--bs-' + color);
           //console.log(datavalue);
            options = {
...
// for logo fixed things
$(document).ready(function(){

    $("#kt_aside").hover(
        function () {

            $('#kt_aside_logo a img').attr('src','http://127.0.0.1:8000/static/admins/EnCars_Fav.png')
